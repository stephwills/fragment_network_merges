...
class Config(metaclass=Singleton):
    CONFIG_DICT = dict(
        ...
        RESTAPI_USER="swills",
        RESTAPI_PASS=None,  # export to bash before execution; export NEO4J_PASS="myPass",
        ...
        MAX_FRAG_DIST = 5, # the maximum distance between two fragments for them to be merges
        # FOR FILTERING THE SYNTHONS BEFORE QUERYING THE DATABASE
        MIN_CARBONS=3,  # the minimum number of carbons for a synthon to be used,
        SYNTH_OVERLAP=0.5,  # the proportion of overlap between synthon found in fragments A and B to rule out,
    )
