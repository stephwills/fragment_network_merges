...
from merge.find_merges_restAPI import MergerFinder_restAPI


def getFragmentNetworkSearcher(use_neo4j_instead_api=config_merge.USE_NEO4J_INSTEAD_API, **kwargs):
    """
