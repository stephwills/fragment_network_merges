...
class Config_filter(metaclass=Singleton):
    CONFIG_DICT = dict(
        ...
        # FILTER_PIPELINE=['DescriptorFilter', 'EmbeddingFilter', 'ExpansionFilter', 'OverlapFilter', 'FragmensteinFilter'],
        ...
        ATOM_CLASH_DIST=0.5,  # embedding_filter.py; min atom dist in the frag A/B substructures to be clashes/removed
