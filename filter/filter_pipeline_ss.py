...
from filter.config_filter_ss import config_filter
from utils.utils import load_json, get_mol, get_protein


# TODO: not have a completely separate file for this..
...
def main():
    ...
    pipeline = FilterPipelineSS(
        merge,
        smiles,
        None,  # replace synthons with None
        fragmentA,
        fragmentB,
        proteinA,
        proteinB,
